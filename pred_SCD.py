...
import RS_ST as RS
from lib.models_my import HGINet as Net
DATA_NAME = 'ST'
#################################
...
class PredOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--test_dir', required=False, default=r'F:/yq/chapter4/FZ_SCD/test/', help='directory to test images')
        # parser.add_argument('--test_dir', required=False, default=r'E:\cropland\exprimet_data\FZ_SCD\test', help='directory to test images')
        parser.add_argument('--pred_dir', required=False, default=r'D:/yq/PycharmProject/HGINet-torch-main/results/FZ', help='directory to output masks')
        # parser.add_argument('--pred_dir', required=False, default=r'E:\HGINet\results\FZ', help='directory to output masks')
        parser.add_argument('--chkpt_path', required=False, default=r'D:/yq\PycharmProject/HGINet-torch-main/checkpoints/ST/HGINet_72e_mIoU78.98_Sek24.38_Fscd71.72_OA99.02.pth')
...
def main():
    ...
    net = Net(64, num_classes=RS.num_classes, pretrained_path=r'D:/yq/PycharmProject/HGINet-torch-main/pvt_v2_b2.pth').cuda()
