...
def Eval():
    ...
    INFER_DIR1 = 'D:/yq/PycharmProject/HGINet-torch-main/results/FZ/im1/'  # Inference path1
    INFER_DIR2 = 'D:/yq/PycharmProject/HGINet-torch-main/results/FZ/im2/'  # Inference path2
    LABEL_DIR1 = 'F:/yq/chapter4/FZ_SCD/test/label1/'  # GroundTruth path 数据集中的标签
    LABEL_DIR2 = 'F:/yq/chapter4/FZ_SCD/test/label2/'  # GroundTruth path
